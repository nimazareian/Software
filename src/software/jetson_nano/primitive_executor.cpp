    ...
    const TbotsProto::MovePrimitive& move_primitive, const Angle& curr_orientation)
{
    ...
    double acceleration_angular_speed = curr_angular_velocity_.toRadians() + robot_constants_.robot_max_ang_acceleration_rad_per_s_2 * time_step_s_;
...
std::unique_ptr<TbotsProto::DirectControlPrimitive> PrimitiveExecutor::stepPrimitive(
        const unsigned int robot_id, const RobotState &robot_state) // TODO Nima: Revert to angle (orientation)
{
