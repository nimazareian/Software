                              ...
                              const Duration& enemy_reaction_time)
{
    ...
    // negative values.
    return 1 - sigmoid(min_time_diff, 0.0, 1); // TODO (NIMA): Will probably have to tune... Should this be a boolean rather than sigmoid? sigmoid with low sigma is basically a step function
}
