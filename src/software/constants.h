...
const std::string BLUE_NAMED_VALUE_PATH                         = "/blue_named_value";
const std::string YELLOW_NAMED_VALUE_PATH                         = "/yellow_named_value";
...
static constexpr unsigned int SSL_PORT = 10020;
